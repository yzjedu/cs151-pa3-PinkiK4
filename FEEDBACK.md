...
- There is a redundant code in the draw line function. It could have been a function to check and accept a number. 
- The draw line function crashes when I input negative values for one of the choices. 
- There is no option to render program again and again and again. That means there is no while loop. 
